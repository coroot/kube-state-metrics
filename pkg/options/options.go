...
func (o *Options) AddFlags(cmd *cobra.Command) {
	...
	o.cmd.Flags().DurationVar(&o.MinAge, "min-age", 0, "Don't emit kube_pod_* / kube_job_* metrics for resources younger than this. For terminal-phase resources the actual run duration is used. Suppresses high-cardinality from short-lived job/cronjob workloads. 0 disables.")
